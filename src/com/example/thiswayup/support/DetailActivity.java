 ...
 * a particular movie.
 * 
 * Because we can navigate to this Activity from an outside task, we must query
 * NavUtils.shouldUpRecreateTask when handling Up navigation. See the
 * implementation in onOptionsItemSelected.
 * 
 */
