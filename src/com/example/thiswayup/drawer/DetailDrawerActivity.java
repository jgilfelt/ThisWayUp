...
/**
 * This example illustrates usage of the DrawerLayout widget for an activity
 * deep within an application navigation hierarchy.
 * 
 */
public class DetailDrawerActivity extends BaseDrawerActivity implements
		OnItemClickListener {
