...
/**
 * This example illustrates usage of the DrawerLayout widget in an application
 * root activity.
 * 
 */
public class RootDrawerActivity extends BaseDrawerActivity {
	...
	protected void onDrawerItemSelected(int position) {
		...
		// A view switch follows the same basic policies as list or tab
		// navigation in that a view switch does not create navigation history.
		// This pattern should only be used at the root activity of a task,
		// leaving some form of Up navigation active for activities further
		// down the navigation hierarchy.
	...
	public static class CategoryFragment extends ListFragment {
		...
		public void onActivityCreated(Bundle savedInstanceState) {
			...
			mData = sort == SORT_TITLE ? Data.getMoviesByTitle() : Data
					.getMoviesByYear();
		...
		public void onListItemClick(ListView l, View v, int position, long id) {
			...
			Intent intent = new Intent(getActivity(),
					DetailDrawerActivity.class);
			intent.putExtra(DetailDrawerActivity.ARG_ID, movie.getId());
			intent.putExtra(DetailDrawerActivity.ARG_INFO,
					getString(R.string.info_detail_from_nav_drawer));
