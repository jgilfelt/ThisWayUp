...
public class Data {
	...
	static {
		...
		sMovies.put(1, new Movie(1, GENRE_ACTION, "Die Hard", 1988,
				R.drawable.diehard));
		sMovies.put(2, new Movie(2, GENRE_ACTION, "Lethal Weapon", 1987,
				R.drawable.lethalweapon));
		sMovies.put(3, new Movie(3, GENRE_ACTION, "The Terminator", 1984,
				R.drawable.terminator));
		sMovies.put(4, new Movie(4, GENRE_DRAMA, "A Few Good Men", 1992,
				R.drawable.fewgoodmen));
		sMovies.put(5, new Movie(5, GENRE_DRAMA, "JFK", 1991, 
				R.drawable.jfk));
		sMovies.put(6, new Movie(6, GENRE_DRAMA, "Wall Street", 1987,
